    ...
    return this.state.isLoading ? (
      ...
      <View style={styles.container}>
        ...
        <View styles={styles.bottomView}>
          ...
          <Text>Connection status: {this.context.networkContext.isConnected ? <Icon style={styles.listIcon}name="circle" size={15} color="green" /> : <Icon style={styles.listIcon}name="circle" size={15} color="red" />}</Text>
        </View>
      </View>
